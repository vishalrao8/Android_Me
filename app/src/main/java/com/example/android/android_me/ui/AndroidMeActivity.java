...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headFragment.setImageAssets(AndroidImageAssets.getHeads());
        headFragment.setIndex(1);

        bodyFragment.setImageAssets(AndroidImageAssets.getBodies());
        headFragment.setIndex(1);

        legFragment.setImageAssets(AndroidImageAssets.getLegs());
