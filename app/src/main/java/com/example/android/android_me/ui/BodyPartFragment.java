...
public class BodyPartFragment extends Fragment {
    ...
    private int index;
    private List<Integer> imageAssets;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (imageAssets != null || !imageAssets.isEmpty()) imageView.setImageResource(imageAssets.get(index));
    ...
    public void setImageAssets(List<Integer> imageAssets) {
